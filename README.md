...
This Ansible role is designed to configure **Ubuntu 22.04** to **comply** with the **CIS Ubuntu Linux Benchmark v3.0.0**. \
...
Based on **[CIS Ubuntu Linux 22.04 LTS Benchmark v3.0.0](https://downloads.cisecurity.org/#/)**.
...
# 'true' by default.
cis_ubuntu2204_rule_6_2_4_0: true
```
...
# AIDE cron settings (cis_ubuntu2204_rule_6_3_2)
...
# journald log file rotation (cis_ubuntu2204_rule_6_1_1_1_3)
...
- name: CIS | install on clients
  ...
  roles:
    - role: ansible-cis-ubuntu-2204
      ...
      cis_ubuntu2204_journald_max_file_sec: 1month
      # -------------------------
      cis_ubuntu2204_preferred_capturing_log_method: "rsyslog"
      # -------------------------
...
| 🔴 Not Implemented                                   | 18    |
| Total                                                | 329   |
| Coverage (Implemented/Partly vs Total)               | 94.52 |
...
| 6.1.1.1.2 | Ensure journald log file access is configured (Automated)                                        | 🟢  |     |     |
| 6.1.1.1.3 | Ensure journald log file rotation is configured (Automated)                                      | 🟢  |     |     |
...
| 6.1.1.2.2 | Ensure systemd-journal-upload authentication is configured (Manual)                              | 🟢  |     |     |
| 6.1.1.2.3 | Ensure systemd-journal-upload is enabled and active (Automated)                                  | 🟢  |     |     |
| 6.1.1.2.4 | Ensure systemd-journal-remote service is not in use (Automated)                                  | 🟢  |     |     |
...
| 6.1.2.5   | Ensure rsyslog logging is configured (Automated)                                                 | 🟢  |     |     |
| 6.1.2.6   | Ensure rsyslog is configured to send logs to a remote log host (Automated)                       | 🟢  |     |     |
| 6.1.2.7   | Ensure rsyslog is not configured to receive logs from a remote client (Automated)                | 🟢  |     |     |
| 6.1.2.8   | Ensure logrotate is configured (Automated)                                                       | 🟢  |     |     |
